  ...
  return (
    <>
      <div className="min-h-screen font-sec bg-[#F5F5DC] flex flex-col items-center justify-center px-6 py-12">
        <div className="bg-[#f6feee] p-8 rounded-2xl shadow-lg max-w-3xl opacity-0 translate-y-5 animate-fadeInUp w-full text-center">
          <h1 className="text-5xl font-bold text-[#797777] mb-4">DishDeck</h1>
